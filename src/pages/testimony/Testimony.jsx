...
import { FormatQuote, Close, ChevronLeft, ChevronRight } from '@mui/icons-material';
...
export const Testimony = () => {
  ...
  return (
    <div 
      className="w-full py-8 lg:py-20 bg-gray-50"
              ...
              >
                <div className="p-4 sm:p-5 lg:p-6 pt-10 lg:pt-12 mt-6 lg:mt-8 relative">
                  ...
                  <div className="flex items-center">
                    ...
                    />
                    <div>
                      <h4 className="text-sm lg:text-base font-semibold text-gray-800">{testimonial.name}</h4>
              ...
              <div className="p-4 lg:p-8">
                <div className="flex justify-between items-start mb-4 lg:mb-6">
                  <div>
                    ...
                    <p className="text-sm lg:text-base text-gray-600">{selectedTestimonial.role}</p>
                  </div>
                  <button 
                    onClick={closeTestimonialModal}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 mb-4 lg:mb-8">
                  ...
                  <div className="space-y-3 lg:space-y-4">
                    <div className="bg-gray-50 p-3 lg:p-4 rounded-lg">
                      <h3 className="text-sm lg:text-base font-semibold text-gray-800 mb-1 lg:mb-2">Project</h3>
                      <p className="text-sm lg:text-base">{selectedTestimonial.details.project}</p>
                    </div>
                    <div className="bg-gray-50 p-3 lg:p-4 rounded-lg">
                      <h3 className="text-sm lg:text-base font-semibold text-gray-800 mb-1 lg:mb-2">Duration</h3>
                      <p className="text-sm lg:text-base">{selectedTestimonial.details.duration}</p>
                    </div>
                    <div className="bg-gray-50 p-3 lg:p-4 rounded-lg">
                      <h3 className="text-sm lg:text-base font-semibold text-gray-800 mb-1 lg:mb-2">Key Results</h3>
                      <p className="text-sm lg:text-base">{selectedTestimonial.details.results}</p>
                    </div>
                  </div>
                </div>

                <div className="mb-4 lg:mb-8">
                  <h3 className="text-lg lg:text-xl font-semibold text-gray-800 mb-2 lg:mb-4">Full Story</h3>
                  <p className="text-sm lg:text-base text-gray-700">{selectedTestimonial.details.fullStory}</p>
                </div>
