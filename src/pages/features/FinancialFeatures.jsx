...
- "Provided peace of mind during market volatility" - The Johnson Family`,
  ...
  return (
    <>
      <div className="min-h-screen mt-4 mb-2 bg-gray-50 text-black flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <ToastContainer />
              ...
              >
                ...
                <div className="mb-8 p-4 bg-white rounded-lg border border-gray-200 shadow-sm w-full max-w-xl">
                  <h3 className="font-semibold mb-2 flex items-center justify-center lg:justify-start">
                    <SupportAgent className="text-primary mr-2" /> Financial
                    Support Highlights
                  </h3>
                  <ul className="list-disc pl-5 text-gray-600 text-left">
                    <li>Average response time: under 30 minutes</li>
                    <li>
                      {financialSupportData.satisfaction.rating} client
                      satisfaction rating
                    </li>
                    <li>
                      {financialSupportData.satisfaction.resolutionRate} issue
                      resolution rate
                    </li>
                  </ul>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <div className="mb-6 rounded-lg overflow-hidden shadow">
                    <img
                      src={
                        financialFeatures.find((f) => f.id === openModal).image
                      }
                      alt={
                        financialFeatures.find((f) => f.id === openModal).title
                      }
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-700">
                    {financialFeatures
                      .find((f) => f.id === openModal)
                      .fullDesc.map((item, index) => (
                ...
                <div>
                  <div className="bg-gray-50 p-5 rounded-lg h-full">
                    <h4 className="font-semibold mb-3 text-lg flex items-center">
                      <SupportAgent className="text-primary mr-2" /> Support
                      Features
                    </h4>
                    ...
                    <div className="mt-4 p-4 bg-white rounded border border-gray-200 shadow-sm">
                      ...
                      <p className="text-sm text-gray-600">
                        {
                          financialFeatures.find((f) => f.id === openModal)
                            .stats
                        }
                      </p>
                ...
                <div>
                  <div className="bg-gray-50 p-5 rounded-lg">
                    <h4 className="font-semibold text-lg mb-4 flex items-center">
                      <SupportAgent className="text-primary mr-2" /> Our
                      Financial Support
                    </h4>
                      ...
                      <div className="grid grid-cols-3 gap-4 text-center">
                        <div className="p-2 bg-white rounded shadow-sm">
                          <div className="text-2xl font-bold text-primary">
                            {financialSupportData.satisfaction.rating}
                          </div>
                        ...
                        <div className="p-2 bg-white rounded shadow-sm">
                          <div className="text-2xl font-bold text-primary">
                            {financialSupportData.satisfaction.resolutionRate}
                          </div>
                          <div className="text-xs text-gray-600 mt-1">
                            Resolution Rate
                          </div>
                        ...
                        <div className="p-2 bg-white rounded shadow-sm">
                          <div className="text-2xl font-bold text-primary">
                            {financialSupportData.satisfaction.clientRetention}
                          </div>
                          <div className="text-xs text-gray-600 mt-1">
                            Retention Rate
                          </div>
