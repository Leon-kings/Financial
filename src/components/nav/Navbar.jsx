...
const RegisterForm = ({
  ...
  <div className="max-w-md mx-auto p-8 rounded-2xl shadow-xl bg-gradient-to-br from-purple-50 to-blue-50">
        ...
        <div className="flex flex-col space-y-3 px-2 pt-2 pb-4">
          ...
          {isLoggedIn ? (
            <div className="flex flex-col space-y-2 pt-2 px-3">
              <Link to={"/Dash28739"}>
                <button className="flex items-center text-gray-600 hover:text-blue-600 py-2">
